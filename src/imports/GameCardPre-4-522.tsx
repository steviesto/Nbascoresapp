...
function TeamStats() {
  return (
    <div className="absolute content-center flex flex-wrap gap-[4px_16px] h-[44px] items-center left-[225px] overflow-clip px-[8px] py-[5px] top-[40px] w-[152px]" data-name="teamStats">
      <AwayPpg />
      <AwayOppg />
      <HomePpg />
      <HomeOppg />
...
function TeamStatsHeaderDiv() {
  return (
    <div className="absolute content-stretch flex font-['Barlow:SemiBold',sans-serif] gap-[16px] items-center leading-none left-[221px] not-italic overflow-clip px-[12px] py-[8px] text-[#8e8e93] text-[11px] top-[4px] tracking-[0.44px]" data-name="teamStatsHeader-div">
