  ...
  return (
    <div className="relative shrink-0 w-[221px]" data-name="timeNetwork-div">
      <div className="content-stretch flex items-center justify-between not-italic overflow-clip p-[8px] relative rounded-[inherit] text-[11px] text-nowrap tracking-[0.22px] w-full">
        <p className="font-['Barlow:Bold',sans-serif] leading-none relative shrink-0 text-white uppercase">Final</p>
        <p className="font-['Barlow:SemiBold',sans-serif] leading-none relative shrink-0 text-[#c7c7cc] text-right">
          LAL +5.5<span className="text-[#8e8e93]">{` |`}</span>
          <span>{` O 215.5`}</span>
        </p>
      </div>
...
function TeamStatsHeaderDiv() {
  return (
    <div className="content-stretch flex font-['Barlow:SemiBold',sans-serif] gap-[8px] items-center leading-none not-italic overflow-clip pl-[12px] pr-0 py-[8px] relative shrink-0 text-[#8e8e93] text-[11px] tracking-[0.44px] w-[156px]" data-name="teamStatsHeader-div">
      <p className="relative shrink-0 w-[28px]">FG%</p>
      <p className="relative shrink-0 w-[36px]">3P/A</p>
      <p className="relative shrink-0 w-[32px]">FT/A</p>
      <p className="relative shrink-0 w-[20px]">TO</p>
    </div>
  );
}
...
function BetTotal() {
  return (
    <div className="content-stretch flex h-[20px] items-center justify-end overflow-clip relative shrink-0" data-name="betTotal">
      <p className="font-['Barlow_Semi_Condensed:Bold',sans-serif] leading-none not-italic relative shrink-0 text-[20px] text-nowrap text-right text-white tracking-[0.4px]">89</p>
    </div>
  );
}
...
function BetSpread() {
  return (
    <div className="content-stretch flex h-[20px] items-center justify-end overflow-clip relative shrink-0" data-name="betSpread">
      <p className="font-['Barlow_Semi_Condensed:Bold',sans-serif] leading-none not-italic relative shrink-0 text-[20px] text-nowrap text-right text-white tracking-[0.4px]">100</p>
    </div>
  );
}
...
function TeamStatsAway() {
  return (
    <div className="content-stretch flex font-['Barlow:SemiBold',sans-serif] gap-[8px] h-[22px] items-end leading-none not-italic overflow-clip px-[8px] py-[5px] relative shrink-0 text-[#d1d1d6] tracking-[0.26px] uppercase w-[152px]" data-name="teamStatsAway">
      <p className="relative shrink-0 text-[0px] w-[28px]">
        <span className="text-[13px]">48</span>
        <span className="font-['Barlow:Medium',sans-serif] not-italic text-[11px]">%</span>
      </p>
      <p className="relative shrink-0 text-[0px] w-[36px]">
        <span className="text-[13px]">10</span>
        <span className="font-['Barlow:Medium',sans-serif] not-italic text-[11px]">/</span>
        <span className="text-[13px]">38</span>
      </p>
      <p className="relative shrink-0 text-[0px] w-[32px]">
        <span className="text-[13px]">18</span>
        <span className="font-['Barlow:Medium',sans-serif] not-italic text-[11px]">/</span>
        <span className="text-[13px]">28</span>
      </p>
      <p className="relative shrink-0 text-[13px] w-[20px]">17</p>
    </div>
  );
}

function TeamStatsHome() {
  return (
    <div className="content-stretch flex font-['Barlow:SemiBold',sans-serif] gap-[8px] h-[22px] items-end leading-none not-italic overflow-clip px-[8px] py-[5px] relative shrink-0 text-[#d1d1d6] tracking-[0.26px] uppercase w-[152px]" data-name="teamStatsHome">
      <p className="relative shrink-0 text-[0px] w-[28px]">
        <span className="text-[13px]">48</span>
        <span className="font-['Barlow:Medium',sans-serif] not-italic text-[11px]">%</span>
      </p>
...
function TeamStats() {
  return (
    <div className="content-stretch flex flex-col h-[44px] items-start justify-center relative shrink-0" data-name="teamStats">
      <TeamStatsAway />
      <TeamStatsHome />
    </div>
  );
...
function GameData() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[377px]" data-name="gameData">
      <Matchup />
      <TeamStats />
    </div>
  );
...
export default function GameCardPre() {
  return (
    <div className="relative rounded-[8px] size-full" data-name="gameCard-pre">
      ...
      <div className="content-end flex flex-wrap gap-[8px_4px] items-end overflow-clip pb-[16px] pt-0 px-0 relative rounded-[inherit] size-full">
        <GameCardHeader />
        <GameData />
      </div>
